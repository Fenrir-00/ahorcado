...
def ahorcado():
 ...
 while 7 > vidas:
  ...
  if var2 in palabrasecreta:
   ...
   ahor+=1
 if vidas == 7:
  perdiste(palabrasecreta)

def perdiste(palabrasecreta):
  banner()
  print(f"{color.rojo}")
  print(AHORCADO[6])
  print(f"{color.amarillo}LA PALABRA SECRETA ES :¡¡¡{palabrasecreta}!!!")
  print()
  print(f"{color.morado}....QUIERES JUGAR OTRA VEZ....")
  print()
